...
def main(): 
    ...
    parser.add_argument('--activations_dataset', type=str, default=None, help='feature bank for calculating std along direction') # hyperparameter
    parser.add_argument('--num_heads', type=int, default=24, help='K, number of top heads to intervene on') # hyperparameter
    parser.add_argument('--num_layers', type=int, default=1, help='K, number of top layers to intervene on') # hyperparameter
    parser.add_argument('--alpha1', type=float, default=15, help='alpha, intervention strength') # hyperparameter
    parser.add_argument('--alpha2', type=float, default=0.5, help='alpha, intervention strength') # hyperparameter
    parser.add_argument('--lr', type=float, default=1e-5, help='Learning rate') # hyperparameter
    parser.add_argument('--lambda_recon', type=float, default=1e-5, help='Reconstruction loss') # hyperparameter
    ...
    head_wise_activations_base_iti = rearrange(head_wise_activations_base, 'b l (h d) -> b l h d', h = num_heads)
    head_wise_activations_instruct_iti = rearrange(head_wise_activations_instruct, 'b l (h d) -> b l h d', h = num_heads)
