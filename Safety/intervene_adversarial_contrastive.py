...
def train_probes(seed, train_set_idxs, val_set_idxs, head_wise_activations, labels,
...
def main(): 
    ...
    parser.add_argument('--lambda_contrastive', type=float, default=0.5, help='Contrastive loss') # hyperparameter
    ...
    for i in range(args.num_fold):
        ...
        head_wise_activations_training = np.concatenate([head_wise_activations_base[train_idxs,:,:], head_wise_activations_instruct[train_idxs,:,:]], axis=0)
        ...
        for layer in top_layers :
            ...
            fake_activations = head_wise_activations_base[train_idxs,layer,:]
