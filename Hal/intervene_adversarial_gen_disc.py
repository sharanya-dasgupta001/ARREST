...
def main(): 
    ...
    parser.add_argument('--num_layers', type=int, default=1, help='K, number of top heads to intervene on')
    ...
    labels_instruct = np.zeros(head_wise_activations_truth.shape[0])
    ...
    for i in range(args.num_fold):
        ...
        filename = f'{args.dataset_name}_{args.model_name}_top{args.num_layers}layers_alpha{args.alpha}_advboth_attn'
